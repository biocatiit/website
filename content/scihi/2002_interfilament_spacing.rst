...
.. row::
    ...
    .. column::
        ...
        changes in ventricular filling, a mechanism known as Frank Starling’s
        law of the heart. Part of the cellular basis for the law
        is an increase in myofilament Ca\ :sup:`2+` responsiveness upon an
        ...
        increase in SL underlies the Ca\ :sup:`2+` sensitivity.

        In support of this hypothesis, shrinkage of the myofilament
        lattice by osmotic compression using high-molecular-weight
        moieties has been shown to increase myofilament Ca\ :sup:`2+` sensitivity
        ...
        To assess the effect of SL on myofilament Ca\ :sup:`2+` sensitivity,
        Ca\ :sup:`2+`-contraction force relationships were determined at three
        ...
        caused a general increase in myofilament Ca\ :sup:`2+` sensitivity at
        ...
        and SL by using synchrotron x-ray diffraction at the Biophysics
        Collaborative Access Team beamline 18-ID. Increasing dextran
        ...
        interfilament spacing on myofilament Ca\ :sup:`2+` sensitivity is not constant
        ...
        Ca\ :sup:`2+` sensitivity, despite the reduction in myofilament LS.
        ...
        .. thumbnail::
            ...
            .. caption::
                ...
                Fig. 1 Part A shows the average myofilament LS as a function
                of SL in skinned cardiac trabeculae bathed in either a 0%
                (top, rectangles), 3% (middle, squares), or 6% (bottom, diamonds)
                dextran solution (n = 8 to 10). The relationships were obtained
                by averaging the data into 0.05-μm-wide SL bins. Part B shows
                the average impact of SL on myofilament LS (ΔLS) and Ca\ :sup:`2+`
                sensitivity (ΔEC\ :sub:`50`) at each dextran concentration. Note the
                significant differences from control group (0% dextran),
                P is <0.01; P is <0.01 from 3% dextran group. For this test
                case, the average Ca\ :sup:`2+` sensitivities (as indexed by
                the EC\ :sub:`50`  parameter), are given in C.
        ...
        Ca\ :sup:`2+` sensitivity. The precise reason for the discrepancies
        ...
        myofilament LS on Ca\ :sup:`2+` sensitivity, depending on the overall
        extent of LS compression. At 6% dextran, LS reduction relative
        to that at 3% dextran was not matched by a further increase in
        Ca\ :sup:`2+` sensitivity, in contradiction to the theory. The relationship
        between interfilament spacing and Ca\ :sup:`2+` sensitivity may therefore
        be highly nonlinear. However, the 1% dextran test indicates
        that changes in LS per se are not responsible for increased Ca\ :sup:`2+`
        sensitivity. If they were, the moderately compressed trabeculae at
        short SL should have behaved similarly to uncompressed trabeculae
        at long SL, given the equivalent LS.

        See: J.P. Konhilas, T.C. Irving, and P. deTombe, "Myofilament calcium
        sensitivity in skinned rat cardiac trabeculae — Role of interfilament
        spacing," Circ. Res. 90, 59-65 (2002).
